// const { getInstalledBinaries } = require("node-sass/lib/extensions");

const shoppingList = document.querySelector(".shopping-list"); // bu classa tekil olarak erişiyoruz.
const shoppingForm = document.querySelector(".shopping-form");
const filterButtons = document.querySelectorAll(".filter-buttons button"); //referans alma
...
}); //sayfadaki bütün bileşenler yüklenicek  onbdan sonra buradaki kodlar çalışacak html hazır olacak sonra çağırılacak style veimg dosyaları haric
//load olursa resim ve img dosyaklarıda yüklendikten sonra gelir.
function clear() {
